...
sendAsyncMessage("get_pn");
addMessageListener("thePN", function(msg) {
    // Setup for display of EPF
    var PN_saved = msg.data;
    if (PN_saved[0] === "") {
        //SOME ERROR
    }
    ...
    var list_b = document.getElementById("Builds");
        ...
        sendAsyncMessage('dir_check', dir_var);
        ...
        //RETURNS
        addMessageListener("thefiles" + "1", function(msg) {
            var b_list1 = msg.data;
        ...
        addMessageListener("thefiles" + "2", function(msg) {
            var b_list2 = msg.data;
        ...
        addMessageListener("thefiles" + "3", function(msg) {
            var b_list3 = msg.data;
        ...
        addMessageListener("thefiles" + "4", function(msg) {
    ...
    var list_cp = document.getElementById("Correspondence_and_Presentations");
        ...
        //RETURNS
        addMessageListener("thefiles" + "5", function(msg) {
            var cp_list1 = msg.data;
        ...
        addMessageListener("thefiles" + "6", function(msg) {
    ...
    var list_c = document.getElementById("Costs");
        ...
        //RETURNS
        addMessageListener("thefiles" + "7", function(msg) {
            var c_list1 = msg.data;
        ...
        addMessageListener("thefiles" + "8", function(msg) {
            var c_list2 = msg.data;
    ...
    var list_de = document.getElementById("Design_and_Engineering");
        ...
        //RETURNS
        addMessageListener("thefiles" + "9", function(msg) {
            var de_list1 = msg.data;
        ...
        addMessageListener("thefiles" + "10", function(msg) {
            var de_list2 = msg.data;
        ...
        addMessageListener("thefiles" + "11", function(msg) {
            var de_list3 = msg.data;
        ...
        addMessageListener("thefiles" + "12", function(msg) {
            var de_list4 = msg.data;
        ...
        addMessageListener("thefiles" + "13", function(msg) {
            var de_list5 = msg.data;
        ...
        addMessageListener("thefiles" + "14", function(msg) {
            var de_list6 = msg.data;
        ...
        addMessageListener("thefiles" + "15", function(msg) {
            var de_list7 = msg.data;
        ...
        addMessageListener("thefiles" + "16", function(msg) {
            var de_list8 = msg.data;
        ...
        addMessageListener("thefiles" + "17", function(msg) {
            var de_list9 = msg.data;
    ...
    var list_dc = document.getElementById("Dimension_Checks");
        ...
        //RETURNS
        addMessageListener("thefiles" + "18", function(msg) {
            var dc_list1 = msg.data;
        ...
        addMessageListener("thefiles" + "19", function(msg) {
            var dc_list2 = msg.data;
        ...
        addMessageListener("thefiles" + "20", function(msg) {
            var dc_list3 = msg.data;
        ...
        addMessageListener("thefiles" + "21", function(msg) {
            var dc_list4 = msg.data;
    ...
    var list_pc = document.getElementById("Prints_and_CAD");
        ...
        //RETURNS
        addMessageListener("thefiles" + "22", function(msg) {
            var pc_list1 = msg.data;
        ...
        addMessageListener("thefiles" + "23", function(msg) {
            var pc_list2 = msg.data;
        ...
        addMessageListener("thefiles" + "24", function(msg) {
            var pc_list3 = msg.data;
        ...
        addMessageListener("thefiles" + "25", function(msg) {
            var pc_list4 = msg.data;
        ...
        addMessageListener("thefiles" + "26", function(msg) {
            var pc_list5 = msg.data;
